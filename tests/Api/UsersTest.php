...
class UsersTest extends MilexApiTestCase
{
    ...
    protected function getUniqueUser()
    {
        ...
        return [
            ...
            'role' => 1, // Should exist in every Milex instance
        ];
    }
    ...
    {
        $this->markTestSkipped('Skipped because we\'re waiting for https://github.com/milex/milex/issues/9621 to be fixed');
