[![codecov](https://codecov.io/gh/milex/api-library/branch/master/graph/badge.svg)](https://codecov.io/gh/milex/api-library) [![Latest Stable Version](https://poser.pugx.org/milex/api-library/v)](//packagist.org/packages/milex/api-library) [![Total Downloads](https://poser.pugx.org/milex/api-library/downloads)](//packagist.org/packages/milex/api-library) [![Latest Unstable Version](https://poser.pugx.org/milex/api-library/v/unstable)](//packagist.org/packages/milex/api-library) [![License](https://poser.pugx.org/milex/api-library/license)](//packagist.org/packages/milex/api-library)
<!-- ALL-CONTRIBUTORS-BADGE:START - Do not remove or modify this section -->
[![All Contributors](https://img.shields.io/badge/all_contributors-3-orange.svg?style=flat-square)](#contributors-)
<!-- ALL-CONTRIBUTORS-BADGE:END -->

# Using the Milex API Library
...
```bash
composer require milex/api-library
```

## Milex Setup
The API must be enabled in Milex. Within Milex, go to the Configuration page (located in the Settings menu) and under API Settings enable
Milex's API. If you intend to use Basic Authentication, ensure you enable it. You can also choose which OAuth protocol to use here.  After saving the configuration, go to the API Credentials page (located in the Settings menu) and create a new client.  Enter the callback/redirect URI that the request will be sent from.  Click Apply, then copy the Client ID and Client Secret to the application that will be using the API.

## Authorization

### Obtaining an access token
The first step is to obtain authorization.  Milex supports OAuth 1.0a and OAuth 2, however it is up to the administrator
...
$settings = [
    'baseUrl'          => '',       // Base URL of the Milex instance
    'version'          => 'OAuth2', // Version of the OAuth can be OAuth2 or OAuth1a. OAuth2 is the default value.
    'clientKey'        => '',       // Client/Consumer key from Milex
    'clientSecret'     => '',       // Client/Consumer secret key from Milex
...
// and the base URL to the Milex server (i.e. http://my-milex-server.com/api/)
...
See the [developer documentation](https://developer.milex.org).
...
In order to get started quickly, we recommend that you use [DDEV](https://ddev.readthedocs.io/en/stable/) which sets things up automatically for you. It clones [https://github.com/milex/milex](milex/milex), sets up a local instance for you, and connects the API library tests to that instance.
...
Configure the unit tests config before running the unit tests. The tests fire real API requests to a Milex instance. 
...
<table>
  <tbody>
    <tr>
      <td align="center"><a href="https://webmecanik.com"><img src="https://avatars.githubusercontent.com/u/462477?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Zdeno Kuzmany</b></sub></a><br /><a href="https://github.com/milex/api-library/commits?author=kuzmany" title="Code">💻</a></td>
      <td align="center"><a href="https://github.com/dlopez-akalam"><img src="https://avatars.githubusercontent.com/u/6641589?v=4?s=100" width="100px;" alt=""/><br /><sub><b>dlopez-akalam</b></sub></a><br /><a href="https://github.com/milex/api-library/commits?author=dlopez-akalam" title="Code">💻</a></td>
      <td align="center"><a href="https://github.com/mollux"><img src="https://avatars.githubusercontent.com/u/3983285?v=4?s=100" width="100px;" alt=""/><br /><sub><b>mollux</b></sub></a><br /><a href="https://github.com/milex/api-library/commits?author=mollux" title="Code">💻</a></td>
    </tr>
  </tbody>
</table>
