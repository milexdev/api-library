...
use Milex\Exception\AuthorizationRequiredException;
use Milex\Exception\IncorrectParametersReturnedException;
...
class OAuth extends AbstractAuth
{
    ...
    /**
     * @param string $baseUrl            URL of the Milex instance
    ...
    protected function getQueryParameters($isPost, $parameters)
    {
        ...
        if (isset($parameters['file'])) {
            // Milex's OAuth2 server does not recognize multipart forms so we have to append the access token as part of the URL
